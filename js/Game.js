class Game {
  ...
  play() {
    ...
    if (allPlayers !== undefined) {
      ...
      // Indice del arreglo (array)
      var index = 0;

      for (var plr in allPlayers) {
        // Agrega 1 al indice por cada iteración
        index = index + 1;
        ...
        if (index === player.index) {
          ...
          // Cambia la posición de la cámara en la dirección y
  ...
  showLeaderboard() {
    ...
    if (
      ...
      // &emsp;    Esta etiqueta es usada para desplegar cuatro espacios
      leader1 =
        players[0].rank +
        "&emsp;" +
        players[0].name +
  ...
  handleFuel(index) {
    ...
    // Reducir el combustible del carro del jugador
